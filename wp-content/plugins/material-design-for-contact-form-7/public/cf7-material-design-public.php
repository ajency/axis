...
class CF7_Material_Design
{
    ...
    public function add_scripts_and_styles()
    {
        ...
        wp_enqueue_style( 'cf7-material-design', plugins_url( '../assets/css/cf7-material-design.css', __FILE__ ) );
    }
    ...
    public function md_form_shortcode( $atts, $content = '' )
    {
        ...
        if ( current_user_can( 'install_plugins' ) && !is_customize_preview() ) {
            ?>
					<div class="cf7md-admin-customize-message">
						<p><a href="<?php 
            echo  $customize_url ;
            ?>" title="Only admins can see this message">Customize your form's colours and fonts.</a></p>
					</div>
				<?php 
        }
