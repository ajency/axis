...
<?php if ( hb_options('hb_to_top_button') && !is_page_template('page-blank.php') && !is_page_template('page-blank-w-footer.php') ) { ?>
<!-- Back to Top Button -->
<a id="to-top"><i class="<?php echo hb_options('hb_back_to_top_icon'); ?>"></i></a>
<!-- END #to-top -->
<?php } ?>

<?php if ( !is_page_template('page-blank.php') && !is_page_template('page-blank-w-footer.php') && hb_options('hb_enable_quick_contact_box') ) {
...
if ( !is_page_template('page-presentation-fullwidth.php') ){
 if ( !is_page_template('page-blank.php') && !is_page_template('page-blank-w-footer.php') && (hb_options('hb_enable_pre_footer_area') && vp_metabox('layout_settings.hb_pre_footer_callout') == "default" || hb_options('hb_enable_pre_footer_area') && vp_metabox('layout_settings.hb_pre_footer_callout') == "" || vp_metabox('layout_settings.hb_pre_footer_callout') == "show" ) ) {
...
if (
	...
	!is_page_template('page-blank.php') && !is_page_template('page-blank-w-footer.php')
) { ?>
...
<footer id="footer" class="dark-style<?php echo $footer_bg_image; ?>" <?php echo $footer_bg; ?>>
	...
	<script type="text/javascript">
		...
		s1.async=true;
		s1.src='https://embed.tawk.to/57764bbd22723f0b61e178b7/default';
		s1.charset='UTF-8';
...
<?php
if ( !is_page_template( 'page-presentation-fullwidth.php' ) ){
if ( hb_options('hb_enable_footer_copyright') && !is_page_template('page-blank.php') && !is_page_template('page-blank-w-footer.php') ) {
