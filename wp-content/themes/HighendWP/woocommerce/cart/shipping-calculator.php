...
<div class="hb-accordion-single">
	<div class="hb-accordion-tab"><i class="hb-moon-truck"></i><?php _e( 'Calculate Shipping', 'woocommerce' ); ?><i class="icon-angle-right"></i></div>
	<div class="hb-accordion-pane">
		<form class="shipping_calculator-hb" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">

			<section class="shipping-calculator-form-hb">
				...
				<p class="update-totals-button nbm"><button type="submit" name="calc_shipping" value="1" class="button"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
