...
<div <?php post_class( $classes ); ?>>
	...
	<div class="hb-woo-image-wrap">
		...
		if ( ! $product->is_in_stock() ) {
			$hb_add_to_cart = '<a href="'. apply_filters( 'out_of_stock_add_to_cart_url', get_permalink( $product->get_id() ) ).'" class="hb-buy-button'.$out_of_stock_class.'">'. apply_filters( 'out_of_stock_add_to_cart_text', __( 'READ MORE', 'woocommerce' ) ).'</a>';
