...
( (function( $ ) {
	...
	wp.customize( 'hb_focus_color_setting', (function( value ) {
		value.bind( (function( newval ) {
			...
			jQuery("<style id='hb-toremove'>\
				...
				.hb-side-nav li a:hover, .hb-side-nav li.current-menu-item > a,\
				...
				.hb-non-transparent .hb-side-nav > li > a:hover, .hb-non-transparent .hb-side-nav > li.current-menu-item > a, .hb-non-transparent .hb-side-nav > li.current-menu-ancestor > a, .hb-non-transparent .hb-side-nav > li.sfHover > a,\
	...
	/* SIDE NAV SECTION
    ================================================== */
	wp.customize('hb_side_nav_bg_setting',(function( value ) {
		value.bind((function(newval) {
			$('#hb-side-navigation').css('background-color', newval ? newval : '' );
		}));
	}));
	...
	wp.customize('hb_side_section_bg_setting',(function( value ) {
		value.bind((function(newval) {
			jQuery('#hb-side-section').css('background-color', newval ? newval : '' );
		}));
	}));
