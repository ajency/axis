			...
			<div class="vp-left-panel">
				...
				<div id="vp-menus" class="vp-menus">
					<ul class="vp-menu-level-1">
						...
						<?php if ( !$menu->get_title() ) continue; ?>
			...
			<div class="vp-right-panel">
				<form id="vp-option-form" class="vp-option-form vp-js-option-form" method="POST">
					<div id="vp-submit-top" class="vp-submit top">
						<div class="inner">
							<a href="http://www.anrdoezrs.net/links/8353661/type/dlg/http://www.mojomarketplace.com/item/wordpress-support" target="_blank" class="hb-expert-help">Need help? Get WordPress experts at your side.</a>
