...
?>>
	...
	<div id="maintenance-footer">
		...
		<ul class="social-list">
            <?php
				$target = ' target="_self"';
				if ( hb_options('hb_soc_links_new_tab') ){ $target = ' target="_blank"'; }
                ...
                if ( !empty ( $hb_socials ) ) {
                    ...
                    ?>
                    <?php if ($hb_social_n != 'behance' && $hb_social_n != 'vk' && $hb_social_n != 'envelop' && $hb_social_n != 'twitch' && $hb_social_n != 'weibo' && $hb_social_n != "tripadvisor" && $hb_social_n != 'sn500px') { ?>
                            <li>
